...
const I18N_DICT = {
  fr: {
    ...
    "ai.too_short": "Pouvez-vous préciser votre question ? (ex : \"huile pour cheveux secs\")",
    "ai.situation_intro": "D'après ce que vous décrivez, voici ce qui pourrait vous aider :",
    "ai.disclaimer_health": "Je peux donner des informations générales, mais je ne remplace pas l'avis d'un professionnel de santé.",
    "lang.ar": "العربية",
    "lang.fr": "Français"
  },
  ar: {
    ...
    "ai.too_short": "هل يمكنك توضيح سؤالك أكثر؟ (مثال: \"زيت للشعر الجاف\")",
    "ai.situation_intro": "بناءً على ما وصفته، إليك ما قد يساعدك:",
    "ai.disclaimer_health": "يمكنني تقديم معلومات عامة فقط، ولا أغني عن استشارة مختص صحي.",
    "lang.ar": "العربية",
    "lang.fr": "Français"
  }
};
