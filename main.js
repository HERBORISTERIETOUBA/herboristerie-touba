...
async function renderProductPage() {
    ...
    if (whatsBtn) {
        whatsBtn.addEventListener("click", async () => {
            ...
            const city = pdCitiesList.find(c => c.name === cityName);
            const deliveryFee = city ? Number(city.price) || 0 : 0;
            ...
            message += "- " + product.name + " x" + qty + " (" + subtotal + " DH)%0A";
            message += "- Livraison (" + cityName + ") : " + deliveryFee + " DH%0A";
            message += "%0ATotal : " + total + " DH%0A%0A";
